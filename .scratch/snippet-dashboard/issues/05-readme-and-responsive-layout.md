...
- [ ] Narrow-width defaults for panel visibility implemented (desktop: expanded list + collapsed console; mobile: icon rail + collapsed console strip)
